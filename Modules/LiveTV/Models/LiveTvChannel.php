...
class LiveTvChannel extends BaseModel
{
    ...
    {
        return LiveTvChannel::selectRaw('DISTINCT live_tv_channel.id,live_tv_channel.name,live_tv_channel.plan_id,plan.level as plan_level,live_tv_channel.description,live_tv_channel.status,live_tv_channel.access,ltc.name as category,ltscm.stream_type,ltscm.embedded,ltscm.server_url,ltscm.server_url1,poster_url as poster_url,poster_tv_url as poster_tv_url,poster_url as base_url')
        ->join('live_tv_stream_content_mapping as ltscm','ltscm.tv_channel_id','=','live_tv_channel.id')
        ->leftJoin('plan','plan.id','=','live_tv_channel.plan_id')
        ->leftJoin('live_tv_category as ltc','ltc.id','=','live_tv_channel.category_id')
        ->where('live_tv_channel.status',1)
    ...
    {
        return LiveTvChannel::selectRaw('live_tv_channel.id,live_tv_channel.name,live_tv_channel.plan_id,plan.level as plan_level,live_tv_channel.description,live_tv_channel.status,live_tv_channel.access,ltc.name as category,ltscm.stream_type,ltscm.embedded,ltscm.server_url,ltscm.server_url1,poster_url as poster_url,poster_tv_url as poster_tv_url,poster_url as base_url')
        ->join('live_tv_stream_content_mapping as ltscm','ltscm.tv_channel_id','=','live_tv_channel.id')
        ->leftJoin('plan','plan.id','=','live_tv_channel.plan_id')
        ->leftJoin('live_tv_category as ltc','ltc.id','=','live_tv_channel.category_id')
