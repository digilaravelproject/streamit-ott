        ...
        <div class="card-description with-transition">
            <div class="position-relative w-100">
                ...
                <div class="d-flex align-items-center gap-3 mt-3">
                    <x-watchlist-button :entertainment-id="$data['id']" entertainmentType="video"
                        :in-watchlist="$data['is_watch_list']" customClass="watch-list-btn" />
                    <div class="flex-grow-1">
                        <a href="{{  route('video-detail', ['id' => $data['id']]) }}" class="btn btn-primary w-100">
