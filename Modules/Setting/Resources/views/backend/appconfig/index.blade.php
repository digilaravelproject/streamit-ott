...
@section('content')
    ...
    @csrf
        ...
        <div class="form-group mb-3">
            <div class="row gy-3">
                <div class="col-md-6">
                    <label for="banner_ad_id">{{ __('messages.lbl_banner_ad_id') }}</label>
                    <input type="text" class="form-control @error('banner_ad_id') is-invalid @enderror" name="banner_ad_id"
                           ...
                           placeholder="{{ __('messages.lbl_banner_ad_id') }}">
                    @error('banner_ad_id')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-md-6">
                    <label for="ios_banner_id">{{ __('messages.lbl_ios_banner_id') }}</label>
