...
class UsersController extends Controller
{
    ...
    public function subscriptionData($id)
    {
        ...
        $subscriptions = $user->subscriptiondata()->with(['subscription_transaction', 'plan'])->get();
        ...
        return DataTables::of($subscriptions)
            ...
            ->addColumn('amount', function ($subscription) {
                return Currency::format($subscription->amount) ?? '--';
            })
            ...
            ->addColumn('duration', function ($subscription) {
                return ($subscription->duration ?? '--') . ' ' . (ucfirst($subscription->type) ?? '--');
            })
