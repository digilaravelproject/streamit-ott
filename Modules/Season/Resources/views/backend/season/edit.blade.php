                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="meta_keywords" id="meta_keywords_input" class="form-control" value="{{ is_array(old('meta_keywords')) ? ($seo->meta_keywords ?? '') : (old('meta_keywords', $seo->meta_keywords ?? '')) }}" placeholder="{{ __('placeholder.lbl_meta_keywords') }}" >
